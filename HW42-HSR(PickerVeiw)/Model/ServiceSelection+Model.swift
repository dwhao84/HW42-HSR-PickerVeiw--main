...
let servicesData: [ServiceSelection] = [
    ServiceSelection(service: "去程時間", subtitleService: getCurrentTime(), serviceIcon: Images.calendar),
    ServiceSelection(service: "車廂種類", subtitleService: "標準車廂",         serviceIcon: Images.tram ),
    ServiceSelection(service: "乘客人數", subtitleService: "全票*1",          serviceIcon: Images.personfill),
    ServiceSelection(service: "座位偏好", subtitleService: "無偏好",          serviceIcon: Images.carseat)
 ]
